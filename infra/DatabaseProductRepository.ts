...
export class DatabaseProductTypeRepository implements ProductTypeRepository {
  ...
  async update(
    ...
    if (productTypeData.name !== undefined)
      updateData.name = productTypeData.name;
    if (productTypeData.displayName !== undefined)
      updateData.displayName = productTypeData.displayName;
    if (productTypeData.description !== undefined)
      updateData.description = productTypeData.description;
    if (productTypeData.isActive !== undefined)
      updateData.isActive = productTypeData.isActive;
  ...
  private mapToDomainProduct(dbProduct: any): Product {
    return {
      ...
      variants: (dbProduct.product_variants || []).map((variant: any) => ({
        ...
        attributeValues: (variant.product_variant_attribute_values || []).map(
          (value: any) => ({
