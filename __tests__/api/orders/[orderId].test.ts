...
import { mockOrder, createMockRequest, createMockResponse } from '../simple-helpers'
...
describe('/api/orders/[orderId]', () => {
  ...
  describe('GET', () => {
    ...
    it('should return 400 when orderId is invalid', async () => {
      ...
      mockFindOrderById.execute.mockRejectedValue(new Error('Order ID is required'))
    ...
    it('should return 500 when unexpected error occurs', async () => {
      ...
      mockFindOrderById.execute.mockRejectedValue(new Error('Database connection failed'))
