...
export default function CheckoutPage() {
  ...
  const createOrder = async () => {
    if (!isFormValid()) {
      if (!isCartValid) {
        setError(
          "Hay problemas con los artículos en tu carrito. Por favor revísalos antes de continuar.",
        );
      } else {
        setError(
          "Por favor completa todos los campos obligatorios (email, nombre y dirección de envío).",
        );
      }
      return;
    }
      ...
      <Layout title="Checkout - Miguel Soro">
        <div className="max-w-2xl mx-auto text-center py-12">
          ...
          <p className="text-gray-600 mb-8">
            Añade algunos productos a tu carrito para continuar con el checkout.
          </p>
          <button
            onClick={() => router.push("/")}
      ...
      <div className="space-y-8">
              ...
              <div className="space-y-6 mb-10">
                {cartState.items.map((item) => (
                  <div
                    ...
                    data-testid={`checkout-item-${item.variantId}`}
                  >
                    {item.imageUrl && (
        ...
        <div className="pt-12 border-t border-gray-200 mt-12">
          <div className="max-w-lg mx-auto text-center">
            ...
            {error && (
              <div
                className="border border-red-200 p-4 mb-8 text-left"
            ...
            {isProcessing && (
              <div
                className="border border-gray-200 p-6 text-center mt-8"
