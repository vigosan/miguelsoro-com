      ...
      >
        ...
        >
          <div className="relative min-h-[80vh] lg:min-h-[92vh]">
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-black/80 via-black/50 to-black/75"></div>
        ...
        <section className="py-24 lg:py-32 bg-white">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="grid lg:grid-cols-2 gap-16 lg:gap-20">
              <Reveal>
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-light text-black mb-8 leading-tight text-balance">
        ...
        <section className="py-24 lg:py-32 bg-black text-white -mx-6 lg:-mx-24 px-6 lg:px-24">
          <Reveal className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-light mb-6 leading-tight text-balance">
