                ...
                picture.price > 0 ? (
                  <>
                    <button
                      ...
                      className="w-full flex items-center justify-center rounded-lg bg-gray-900 py-3 px-6 text-base font-medium text-white hover:bg-gray-700 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98]"
                  ...
                  <a
                    href={`mailto:info@miguelsoro.com?subject=Consulta sobre la obra: ${encodeURIComponent(picture.title)}`}
                    className="w-full flex items-center justify-center rounded-lg bg-gray-900 py-3 px-6 text-base font-medium text-white hover:bg-gray-700 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors active:scale-[0.98]"
                  >
                    <svg
                      className="w-5 h-5 mr-2"
                      fill="none"
...
export const getStaticProps: GetStaticProps<PictureDetailProps> = async (
  context,
) => {
  try {
