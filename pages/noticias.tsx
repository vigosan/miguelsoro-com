        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm ring-1 ring-gray-200 overflow-hidden">
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-4">
                Del 8 al 17 de enero de 2025, Miguel Soro expone en el Espai
                d&rsquo;Art del Ayuntamiento de Benidorm con motivo de la Copa
                del Mundo de Ciclocross UCI-Benidorm Costa Blanca 2025. Una
                muestra que combina el arte y el deporte en una de las
                competiciones más importantes del calendario internacional.
              </p>
          ...
          <div className="bg-white rounded-xl shadow-sm ring-1 ring-gray-200 overflow-hidden">
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-4">
                Durante las etapas pirenaicas del Tour de Francia 2024, Miguel
                Soro presentó una exposición en Bagnères de Luchon con obras que
                recorren &ldquo;desde el ciclismo clásico más épico de los años
                30, 40 ó 50, al actual&rdquo;, capturando la esencia histórica
                del ciclismo.
              </p>
              <div className="flex items-center text-sm text-gray-500">
                <svg
          ...
          <div className="bg-white rounded-xl shadow-sm ring-1 ring-gray-200 overflow-hidden">
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-4">
                Con motivo del Giro de Italia 2024, Miguel Soro inauguró una
                exposición en la prestigiosa sala de las Destilerías Nardini en
                Italia, combinando su pasión por el arte y el ciclismo en el
                contexto de una de las tres Grandes Vueltas.
              </p>
              <div className="flex items-center text-sm text-gray-500">
                <svg
                  className="w-4 h-4 mr-2"
          ...
          <div className="bg-white rounded-xl shadow-sm ring-1 ring-gray-200 overflow-hidden">
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-4">
                Miguel Soro inauguró su exposición &ldquo;El Arte del
                Ciclismo&rdquo; en la Casa de la Cultura Ca Don José en Canals,
                con motivo de la Volta Ciclista a la Comunitat Valenciana. Un
                lugar especial donde hace 10 años lanzó una de sus primeras
                exposiciones dedicadas al ciclismo.
              </p>
              <div className="flex items-center text-sm text-gray-500">
                <svg
                  className="w-4 h-4 mr-2"
          ...
          <div className="bg-white rounded-xl shadow-sm ring-1 ring-gray-200 overflow-hidden">
            <div className="p-6 border-b border-gray-200">
              ...
              <p className="text-gray-600">
                Reportaje sobre la exposición de Miguel Soro que pone el acento
                español en el homenaje a los vencedores españoles del Tour de
                Francia.
              </p>
            </div>
            <div className="p-6">
