          ...
          <div className="max-w-4xl mx-auto grid gap-8 lg:grid-cols-2">
            <div className="bg-white rounded-xl shadow-sm ring-1 ring-gray-200 p-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                exciclista profesional, conocido por su talento en las
                bicicletas desde su infancia. Compitió activamente en múltiples
            ...
            <div className="bg-white rounded-xl shadow-sm ring-1 ring-gray-200 p-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                reconocido por su impactante obra pictórica que fusiona su amor
                por la bicicleta y el arte. Migrando su espíritu competitivo al
            ...
            <div className="bg-white rounded-xl shadow-sm ring-1 ring-gray-200 p-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                Su extensa trayectoria incluye exposiciones en museos, eventos
                de ciclismo vintage y galerías internacionales, recibiendo el
                reconocimiento del público y los críticos. Con su pincel,
            ...
            <div className="bg-white rounded-xl shadow-sm ring-1 ring-gray-200 p-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                Siendo reconocido tanto por su trayectoria en el ciclismo como
                en el arte, su obra ha contado con el apoyo de entidades
          ...
          <div className="max-w-3xl mx-auto bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-8">
            <div className="text-center">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Ahora, en esta etapa de su vida artística, Miguel Soro se
                enfrenta a nuevos retos. Con un futuro prometedor en el
                horizonte, avanza hacia nuevos proyectos y exposiciones, con el
                establecimiento de un amplio estudio de arte y el homenaje a
                destacadas figuras del ciclismo mediante su pintura.
              </p>
              <p className="text-lg font-medium text-gray-900 italic">
                &ldquo;Bienvenidos en este viaje a través del arte y el
                deporte.&rdquo;
              </p>
            </div>
          </div>
